...
@Component({
  selector: 'app-demage-entry',
  templateUrl: './demage-entry.component.html',
  styleUrls: ['./demage-entry.component.scss']
})

export class DemageEntryComponent implements OnInit {
