...
@NgModule({
  declarations: [StockLedgerReportComponent, StockmovementreportComponent, StockLedgerComponent, StockReportComponent, StockReportBaseUnitComponent, StockMovementComponent, StockAdjustmentReportComponent, RecorderLevelReportComponent, BOMStatusComponent, IssueReportComponent, InvoiceProfitReportComponent, StockAgeingReportComponent, ItemWiseProfitReportComponent],
  imports: [
    CommonModule,
